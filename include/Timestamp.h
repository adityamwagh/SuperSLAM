...
class Timestamp {
 ...
 public:
  ...
  /**
   * Returns this timestamp as the number of seconds in fixed length std::string
   * format
   */
  ...
  /**
   * Returns a std::string version of the elapsed time in seconds, with the
   * format xd hh:mm:ss, hh:mm:ss, mm:ss or s.us
